...
|---|---|---|
| Langage | Python **3.12** | 3.13 est trop récent : plusieurs dépendances n'ont pas encore de version précompilée pour elle (voir « Problèmes connus ») |
...
Argumentaire détaillé : `docs/choix-techniques.md`.
...
- **Python 3.12** — `winget install Python.Python.3.12`
  (Python 3.13 provoque un échec de compilation de NumPy ; voir « Problèmes connus ».)
- **Git**
...
| `SEUIL_PERTINENCE` | `1.0` | Distance maximale acceptée (voir ci-dessous) |
...
- Recherche vectorielle et filtrage par seuil de pertinence
...
- Rédaction de `docs/seuil-pertinence.md` et `docs/choix-techniques.md`
